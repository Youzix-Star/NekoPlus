...
//
// Ported into NekoPlus with only the package renamed and the transition made public.
...
/** The AOSP-style predictive back: the page scales down, hugs the swiped edge, and drifts. */
